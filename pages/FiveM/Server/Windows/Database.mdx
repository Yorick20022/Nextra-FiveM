...
- Now enter the connection details as follows:
  - Hostname / IP: If you installed MariaDB on the same machine as HeidiSQL, leave it as `127.0.0.1`. If not, enter the public IP of the machine where MariaDB is installed (Port Forwarding needed)
  - User: Leave as `root`
- Press "Open"
