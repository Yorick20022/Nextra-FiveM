...
- Now once you have done all these actions, it's time to setup the database the correct way, please click [this](https://nextra-five-m.vercel.app/FiveM/Server/Database) link:
